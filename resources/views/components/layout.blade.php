        ...
        <div class="flex lg:p-10 p-4 h-full justify-between md:py-4 flex-col">
            <ul class="flex flex-col gap-10 lg:gap-0 lg:p-0 justify-between">
                <li class="">
                    <x-nav-link href="{{ url('/') }}" :active="request()->is('/')">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-5"><rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/></svg>
                ...
                <li>
                    <x-nav-link href="{{ url('visits') }}" :active="request()->is('visits')">
                        <svg width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4">
                ...
                <li class="">
                    <x-nav-link href="{{ url('logs') }}" :active="request()->is('logs')">
                        <svg width="18" stroke="currentColor" class="w-5 h-4" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="">
                    <x-nav-link href="{{ url('users') }}" :active="request()->is('users')">
                        <svg width="20" height="20" class="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <aside class="flex h-fit relative">
                <div id="userDropupButton" class="flex items-center gap-2 rounded-lg cursor-pointer">
                    <svg width="16" height="16" viewBox="0 0 135 122" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4">
