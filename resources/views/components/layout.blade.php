...
<body class="flex w-full">
        ...
        <div class="flex lg:p-10 p-4 h-full justify-between md:py-4 flex-col">
            <ul class="flex flex-col gap-10 lg:gap-0 lg:p-0 justify-between">
                <li class="">
                    <x-nav-link href="{{ url('/') }}" :active="request()->is('/')">
                        {{-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" stroke-width="1.5"
                            stroke="currentColor" class="size-7 lg:size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" />
                        </svg> --}}

                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-7 lg:size-5"><rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/></svg>
                ...
                <li>
                    <x-nav-link href="{{ url('visits') }}" :active="request()->is('visits')">
                        <svg width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-7 lg:size-5">
                ...
                <li class="">
                    <x-nav-link href="{{ url('keys') }}" :active="request()->is('keys')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7 lg:size-5">
                ...
                <li class="">
                    <x-nav-link href="{{ url('logs') }}" :active="request()->is('logs')">
                        <svg width="18" stroke="currentColor" class="size-7 lg:size-5" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="">
                    <x-nav-link href="{{ url('users') }}" :active="request()->is('users')">
                        <svg width="20" height="20" class="size-7 lg:size-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <aside class="flex h-fit relative">
                <div id="userDropupButton" class="flex items-center gap-2 rounded-lg cursor-pointer">
                    <svg width="16" height="16" viewBox="0 0 135 122" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <main class="w-full h-[calc(100vh-1rem)] overflow-auto scrollbar-hidden flex flex-col">
        <header class="flex justify-between items-center w-full border-b border-[#C8DFFF] px-10 py-4">
            @if(\App\Models\Roles::hasPermission(auth()->user()->role_id !== 5, 'visits', 'create'))
                <h1 class="lg:text-xl font-bold text-lg text-gray-800">{{ $heading }}</h1>
            @endif

            @if(\App\Models\Roles::hasPermission(auth()->user()->role_id == 5, 'visits', 'create'))
            <a href="/" class="w-1/6 lg:w-1/12">
                <img src="{{ asset('PS-logo.png') }}" class="" alt="">
            </a>
            @endif
            <div class="w-full gap-10 flex justify-end items-center lg:w-fit text-[#0F51AE] rounded-3xl font-medium">
                <span class="lg:text-xl lg:w-fit text-[#0F51AE] rounded-3xl font-medium" id="date"></span>
                <span class="lg:text-xl lg:w-fit text-[#0F51AE] rounded-3xl font-bold" id="clock"></span>
            </div>
        </header>
